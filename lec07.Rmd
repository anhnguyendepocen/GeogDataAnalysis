...
otl_path <- "/Users/bartlein/Dropbox/DataVis/working/ESSD/data/shp_files/OR/"
otl_name <- "orotl.shp"
otl_file <- paste(otl_path, otl_name, sep="")
# orotl_shp <- readShapeLines(otl_file) # deprecated
...
```{r read stations}
# read stations
orstations_path <- "/Users/bartlein/Dropbox/DataVis/working/ESSD/data/shp_files/OR/"
orstations_name <- "orstations.shp"
orstations_file <- paste(orstations_path, orstations_name, sep="")
#orstations_shp <- readShapePoints(orstations_file) # deprecated
...
vegtype_path <- "/Users/bartlein/Dropbox/DataVis/working/ESSD/data/nc_files/"
...
ncpath <- "/Users/bartlein/Dropbox/DataVis/working/ESSD/data/nc_files/"
...
shp_path <- "/Users/bartlein/Dropbox/DataVis/working/ESSD/data/shp_files/USGS_pp1650/"
shp_name <- "picemari.shp"
shp_file <- paste(shp_path, shp_name, sep="")
# picea_shp <- readShapePoly(shp_file) # deprecated
...
```{r ncdf4 package, messages=FALSE, warning=FALSE, results='hide', cache=FALSE}

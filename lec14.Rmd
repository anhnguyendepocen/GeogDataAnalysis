...
- [the scatter diagram and fitted line](http://geog.uoregon.edu/GeogR/images/nwk2_3.gif)
- [the conceptual model that underlies the interpretation of the line](http://geog.uoregon.edu/GeogR/images/nwk2_4.gif)
- [curvilinear regression](http://geog.uoregon.edu/GeogR/images/nwk2_5.gif)
...
- [the locally weighted "fitted value" at a particular point](http://geog.uoregon.edu/GeogR/images/v3_7.gif)
- [what happens at the margin of the scatter diagram](http://geog.uoregon.edu/GeogR/images/v3_8.gif)
- [the mathematics of loess](http://geog.uoregon.edu/GeogR/topics/loess.pdf)
...
```{r low05}
# loess -- first model
loess.model <- loess(tann ~ elevation)
loess.model
```

```{r low06}
# second model, smoother curve
loess.model2 <- loess(tann ~ elevation, span=0.90, degree=2)
loess.model2
```
...
linear.model <- lm(tann ~ elevation)
linear.model
```
...
lines(elevation[order(elevation)], poly2.hat[order(elevation)],
     col="blue", lwd=2)
lines(spline.model, col="purple", lwd=2)

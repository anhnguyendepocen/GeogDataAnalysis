...
Definition of the [standard error of the mean](http://geog.uoregon.edu/GeogR/topics/semean.pdf)
...
The confidence interval provides a verbal or graphical characterization, based on the information in a sample, of the likely range of values within which the "true" or population mean lies.  This example uses an artificial data set  [[cidat.csv]](http://geog.uoregon.edu/GeogR/data/csv/cidat.csv)
...
- [[simple inferential statistics]](http://geog.uoregon.edu/GeogR/topics/simpleinf.pdf)
...
- [short guide to interpreting test statistics, p-values, and significance](http://geog.uoregon.edu/GeogR/topics/interpstats.pdf)
...
[[Details of the t-test]](http://geog.uoregon.edu/GeogR/topics/ttest.pdf)
...
- [[ttestdat.csv]](http://geog.uoregon.edu/GeogR/data/csv/ttestdat.csv)
- [[foursamples.csv]](http://geog.uoregon.edu/GeogR/data/csv/foursamples.csv)
...
Example data:  [[foursamples.csv]](http://geog.uoregon.edu/GeogR/data/csv/foursamples.csv)

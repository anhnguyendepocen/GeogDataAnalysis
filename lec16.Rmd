...
- Example:  Davis' boxes ([data](http://geog.uoregon.edu/GeogR/figures/Davis_PCA_data.png), [plot](http://geog.uoregon.edu/GeogR/figures/Davis_PCA_boxes.png), [scatter](http://geog.uoregon.edu/GeogR/figures/Davis_PCA_scatter.png), [components](http://geog.uoregon.edu/GeogR/figures/Davis_PCA_scores.png)), (Davis, J.C., 2001, *Statistics and Data Analysis in Geology*, Wiley)
- [Derivation of principal components](http://geog.uoregon.edu/GeogR/topics/pca.pdf)
...
A very simple, two-variable analysis can be illustrated using Davis' boxes data [[boxes.csv]](http://geog.uoregon.edu/GeogR/data/csv/boxes.csv)
...
A second example of a simple PCA analysis can be illustrated using the large-cities data set [[cities.csv]](http://geog.uoregon.edu/GeogR/data/csv/cities.csv)
...
qg.pca.rot <- qgraph(RFtrans.pca.rot)

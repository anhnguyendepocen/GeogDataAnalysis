...
To get the workspace, right-click on this link [[geog495.RData]](https://pjbartlein.github.io/GeogDataAnalysis/data/Rdata/geog495.RData) and save it to your working folder.  (If you've forgotten where that is, type `getwd()` on the command line).  Then read it in to R:
...
example(rgl.spheres)
```
![rgl01](https://pjbartlein.github.io/GeogDataAnalysis/figures/rgl01.jpg)
[[Back to top]](lec05.html)
...
- [Trellis Graphics User Manual](https://pjbartlein.github.io/GeogDataAnalysis/pdfs/trellis.user.pdf), and

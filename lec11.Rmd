...
- [[definition]](http://geog.uoregon.edu/GeogR/topics/anova.pdf)
- [[the null and alternative hypothesis]](http://geog.uoregon.edu/GeogR/images/aov.gif)
...
- [[a test for homogeneity of variance]](http://geog.uoregon.edu/GeogR/topics/bartlett.pdf)
    
Here is an example data set:  [[anovadat.csv]](http://geog.uoregon.edu/GeogR/data/csv/anovadat.csv)
...
See the guide for interpreting p-values for reference:  [short guide to interpreting test statistics, p-values, and significance](http://geog.uoregon.edu/GeogR/topics/interpstats.pdf)

...
Data: [[wus_pratio.csv]](http://geog.uoregon.edu/GeogR/data/csv/wus_pratio.csv)     Shapefile components:  [[wus.shp]](http://geog.uoregon.edu/GeogR/data/shp/wus.shp) [[wus.dbf]](http://geog.uoregon.edu/GeogR/data/shp/wus.dbf) [[wus.shx]](http://geog.uoregon.edu/GeogR/data/shp/wus.shx)
...
con <- url("http://geog.uoregon.edu/GeogR/data/Rdata/geog495.RData")
load(file=con)
close(con)
```
...
# read world.shp
shp_path <- "/Users/bartlein/Projects/ESSD/data/shp_files/world2013/"

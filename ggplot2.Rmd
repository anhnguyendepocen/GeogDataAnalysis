...
- *Aes* ("aesthetic mappings"", that describe how variables are mapped to perceivable attributes of a graphics)
- *Layers* (made up of geometric elements)
- *Geoms* (the geometric objects like points, lines, polygons that )
- *Stats* (or "statistical transformations", i.e. curves)
- *Scales* (that map data into the "aesthetic space", i.e. axes and legends)
- *Coord* (the coordinate system of a plot)
